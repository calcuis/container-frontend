...
/**
 * @license React
 * react.production.min.js (Facebook, Inc. and its affiliates)
 *
...
/**
 * @license React
 * react-jsx-runtime.production.min.js (Facebook, Inc. and its affiliates)
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */
...
/**
 * @license React
 * scheduler.production.min.js (Facebook, Inc. and its affiliates)
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */
...
/**
 * @license React
 * react-dom.production.min.js (Facebook, Inc. and its affiliates)
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */
...
const SHIFTED_RANK = new Map(read_sorted_arrays(r).flatMap((v2, i) => v2.map((x2) => [x2, i + 1 << 24])));
...
const _BaseContract = class _BaseContract {
  constructor(target, abi2, runner, _deployTx) {
    ...
    return new Proxy(this, {
      ...
      has: (target2, prop) => {
        if (prop in target2 || passProperties.indexOf(prop) >= 0) {
          return Reflect.has(target2, prop);
        }
...
const config = {
  "5": {
    gguf: {
      address: "0x7ec34595c19f6e12d62E562D896D7C403fBBcb05"
    }
  },
  "59140": {
    gguf: {
      address: "0x07839b9A6712CC239Ea573174b23B871E819cBA0"
    }
  },
  "80001": {
    gguf: {
      address: "0x631B17eEA8F2bc7b2B43055576157488D306bF73"
    }
  },
  "11155111": {
    gguf: {
      address: "0x11A276eC4332277b389cFbC51f9076517EF16Da9"
    }
  },
  abi
};
const Navbar = ({ theme, toggleTheme, installed, isLoading, account, isAdmin, refreshPage, ensName, ensAvatar, accountBalance, connectWalletHandler, BtnLoad: BtnLoad2, isOwner, nftBalance, chainID, isClosed }) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "absolute top-3 right-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: account && chainID == "1" ? "Mainnet" : chainID == "5" ? "Görli" : chainID == "59140" ? "Linea" : chainID == "11155111" ? "Sepolia" : chainID == "80001" ? "Mumbai" : "" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
          account && (chainID == "1" || chainID == "5" || chainID == "11155111" || chainID == "59140") && /* @__PURE__ */ jsxRuntimeExports.jsx(EthLogo, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-16 right-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${!toggle ? "hidden" : "flex"} p-5 bg-current absolute top-5 right-0 mx-4 my-2 min-w-[100px] rounded-xl z-10`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: `${theme == "light" ? "text-white" : "text-black"} list-none flex justify-end items-start flex-1 flex-col`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account && (!isClosed && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/Shop", children: "Shop" })) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/PanelEgg", children: "EditPig" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ListPig", children: "ListPig" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/PanelDog", children: "Holder" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/PanelPig", children: "PriceEditor" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/RoleChanger", children: "RolePanel" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/WithdrawFund", children: "FundPanel" }) })
        ] }) })
      ] })
    ] })
  );
...
const ListPig = ({ theme, BtnLoad: BtnLoad2, connectWalletHandler }) => {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const initialValues = {
    listName: "",
    listPrice: "",
  ...
  const listHandler = async () => {
    ...
    try {
      let priceInEth = parseEther(values.listPrice);
      const tx = await contract.list(values.listName, priceInEth, values.listImageURI);
      console.log("Submitted! Transaction ID: ", tx.hash);
      await tx.wait();
      console.log("Done! Pig Listed!");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        onClick: listHandler,
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(BtnLoad2, {}) : "List"
      }
    )
  ] });
};
const Pig = ({ pig, kyuri, id: id2, BtnLoad: BtnLoad2, connectWalletHandler, accountBalance, loadShop, chainID, theme }) => {
  ...
  const buyHandler = async () => {
    ...
    try {
      const provider = new BrowserProvider(window.ethereum);
      const signer = await provider.getSigner();
      const transaction = await kyuri.connect(signer).mint(pig.pigId, { value: pig.cost });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: !pig.isOwned && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "m-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold", children: pig.isOwned ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: pig.image, className: "h-52" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("del", { children: pig.name }),
      " ",
      id2,
      " ",
      pig.pigId.toString()
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-slate-500", children: pig.isOwned ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sold" }) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatUnits(pig.cost.toString(), "ether") }),
      (chainID == "1" || chainID == "5" || chainID == "11155111" || chainID == "59140") && "ETH",
      (chainID == "137" || chainID == "80001") && "MATIC"
    ] }) }),
    !pig.isOwned && (accountBalance < parseFloat(formatEther(pig.cost)) ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "justify-center rounded-lg bg-slate-400 px-4 py-2 text-white btn-width", disabled: true, children: "not enough fund" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `${theme == "light" ? "text-white bg-black hover:bg-gray-700" : "text-black bg-gray-200 hover:bg-white"} justify-center rounded-lg px-4 py-2 btn-width`,
        onClick: () => buyHandler(),
        children: buyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(BtnLoad2, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Buy" })
      }
    ))
  ] }) }) });
};
const ShopPig = ({ theme, ArrowLoad: ArrowLoad2, BtnLoad: BtnLoad2, account, connectWalletHandler, accountBalance, chainID }) => {
  ...
  const loadShop = async () => {
    ...
    try {
      const provider = new BrowserProvider(window.ethereum);
      const network = await provider.getNetwork();
      const kyuri2 = new Contract(config[network.chainId.toString()].gguf.address, config.abi, provider);
      setKyuri(kyuri2);
      const maxSupply = await kyuri2.maxSupply();
      const pigs2 = [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    account ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      }).map((pig, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Pig, { pig, kyuri, id: index + 1, BtnLoad: BtnLoad2, connectWalletHandler, accountBalance, loadShop, chainID, theme }, index)) })
    ] }) : "Please Connect🔌Wallet"
  ] });
};
const MyPig = ({ pig, kyuri, id: id2, account, BtnLoad: BtnLoad2, connectWalletHandler, loadPig, theme }) => {
  ...
  const modifyHandler = async () => {
    ...
    try {
      ...
      const network = await provider.getNetwork();
      const contract = new Contract(config[network.chainId.toString()].gguf.address, config.abi, signer);
      const transaction = await contract.modifyPig(pig.pigId, values.tokenName, values.tokenImage);
      console.log("Submitted! Transaction ID: ", transaction.hash);
      await transaction.wait();
...
const Owned = ({ theme, ArrowLoad: ArrowLoad2, account, BtnLoad: BtnLoad2, connectWalletHandler }) => {
  const [kyuri, setKyuri] = reactExports.useState(null);
  const [pigs, setPigs] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(false);
  const loadPig = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: pigs.map((pig, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(MyPig, { pig, kyuri, id: index + 1, account, BtnLoad: BtnLoad2, connectWalletHandler, loadPig, theme }, index)) })
  ] });
};
const RoleChanger = ({ theme, BtnLoad: BtnLoad2, connectWalletHandler, isOwner, isAdmin, isClosed }) => {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const initialValues = {
    ownerAddress: "",
    adminAddress: ""
  ...
  const [ensAddressAdmin, setEnsAddressAdmin] = reactExports.useState(null);
  const getAddressFromEnsAdmin = async () => {
    try {
      const provider = new BrowserProvider(window.ethereum);
      const ensAddressAdmin2 = await provider.resolveName(values.adminAddress);
      setEnsAddressAdmin(ensAddressAdmin2);
    } catch (err) {
    }
  };
  reactExports.useEffect(() => {
    getAddressFromEnsAdmin();
  }, [values.adminAddress]);
  ...
  const [copyAdmin, setCopyAdmin] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { onClick: () => {
        navigator.clipboard.writeText(isAdmin);
        setCopyAdmin(true);
      }, className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5.50282 4.62705L5.5 6.75V17.2542C5.5 19.0491 6.95509 20.5042 8.75002 20.5042L17.3663 20.5045C17.0574 21.3782 16.224 22.0042 15.2444 22.0042H8.75002C6.12667 22.0042 4 19.8775 4 17.2542V6.75C4 5.7693 4.62745 4.93512 5.50282 4.62705ZM17.75 2C18.9927 2 20 3.00735 20 4.25001V17.25C20 18.4926 18.9927 19.5 17.75 19.5H8.75002C7.50736 19.5 6.50002 18.4926 6.50002 17.25V4.25001C6.50002 3.00735 7.50736 2 8.75002 2H17.75ZM17.75 3.50001H8.75002C8.33581 3.50001 8.00002 3.8358 8.00002 4.25001V17.25C8.00002 17.6642 8.33581 18 8.75002 18H17.75C18.1642 18 18.5 17.6642 18.5 17.25V4.25001C18.5 3.8358 18.1642 3.50001 17.75 3.50001Z" }) }),
      copyAdmin && "copied"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { children: [
      ...
      isAddress(values.adminAddress) ? "✔️" : ensAddressAdmin && "✔️",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(BtnLoad2, {}) : "Assign Adim"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2" }),
    isClosed ? "🔴" : "🟢",
...
const WithdrawFund = ({ theme, BtnLoad: BtnLoad2, connectWalletHandler, isOwner }) => {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  ...
  const withdrawHandler = async () => {
    ...
    const contract = new Contract(config[network.chainId.toString()].gguf.address, config.abi, signer);
    try {
      const tx = await contract.redeem(isOwner, parseUnits(contractBalance, "ether"));
      console.log("Submitted! Transaction ID: ", tx.hash);
      await tx.wait();
  ...
  const transferEtherHandler = async () => {
    ...
    const contract = new Contract(config[network.chainId.toString()].gguf.address, config.abi, signer);
    try {
      const transaction = await contract.redeem(isOwner, parseUnits(values.transferAmount, "ether"));
      console.log("Submitted! Transaction ID: ", transaction.hash);
      await transaction.wait();
  ...
  const transferEtherToToHandler = async () => {
    ...
    const contract = new Contract(config[network.chainId.toString()].gguf.address, config.abi, signer);
    try {
      const transaction = await contract.redeem(values.transferAddressTo, parseUnits(values.transferAmountTo, "ether"));
      console.log("Submitted! Transaction ID: ", transaction.hash);
      await transaction.wait();
      console.log("Done! Ether Transferred!");
      connectWalletHandler();
...
const EditPig = ({ pig, kyuri, id: id2, BtnLoad: BtnLoad2, connectWalletHandler, loadShop, chainID, theme }) => {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const initialValues = {
    tokenCost: ""
  };
  ...
  const changeHandler = async () => {
    ...
    const signer = await provider.getSigner();
    try {
      let priceInEth = parseEther(values.tokenCost);
      const tx = await kyuri.connect(signer).modifyCost(pig.pigId, priceInEth);
      console.log("Submitted! Transaction ID: ", tx.hash);
      await tx.wait();
      console.log("Done! Token#" + pig.pigId + " Price Changed!");
      connectWalletHandler();
      loadShop();
    } catch (err) {
      console.log(err);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: !pig.isOwned && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "m-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: pig.image.slice(8, 12) == "ipfs" ? `https://${pig.image.slice(21, 80)}.ipfs.dweb.link/${pig.image.slice(81, 88)}` : pig.image, className: "h-52 rounded-xl" }),
      pig.name
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-slate-500", children: [
      "Price:",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatUnits(pig.cost.toString(), "ether") }),
      (chainID == "1" || chainID == "5" || chainID == "11155111" || chainID == "59140") && "ETH",
      (chainID == "137" || chainID == "80001") && "MATIC"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(BtnLoad2, {}) : "Submit"
      }
    )
  ] }) });
};
const PanelPig = ({ theme, ArrowLoad: ArrowLoad2, BtnLoad: BtnLoad2, account, connectWalletHandler, chainID }) => {
  const [kyuri, setKyuri] = reactExports.useState(null);
  const [pigs, setPigs] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(false);
  const loadShop = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    account ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      }).map((pig, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(EditPig, { pig, kyuri, id: index + 1, BtnLoad: BtnLoad2, connectWalletHandler, loadShop, chainID, theme }, index)) })
    ] }) : "Please Connect🔌Wallet"
  ] });
};
const ModifyPig = ({ pig, kyuri, id: id2, BtnLoad: BtnLoad2, connectWalletHandler, loadShop, chainID, theme }) => {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const initialValues = {
    tokenName: "",
    tokenImage: ""
  ...
  const changeHandler = async () => {
    ...
    const signer = await provider.getSigner();
    try {
      const tx = await kyuri.connect(signer).editPig(pig.pigId, values.tokenName, values.tokenImage);
      console.log("Submitted! Transaction ID: ", tx.hash);
      await tx.wait();
      console.log("Done! Token#" + pig.pigId + " Edited!");
      connectWalletHandler();
      loadShop();
    } catch (err) {
      console.log(err);
...
const PanelEgg = ({ theme, ArrowLoad: ArrowLoad2, BtnLoad: BtnLoad2, account, connectWalletHandler, chainID }) => {
  const [kyuri, setKyuri] = reactExports.useState(null);
  const [pigs, setPigs] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(false);
  const loadShop = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    account ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      }).map((pig, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(ModifyPig, { pig, kyuri, id: index + 1, BtnLoad: BtnLoad2, connectWalletHandler, loadShop, chainID, theme }, index)) })
    ] }) : "Please Connect🔌Wallet"
  ] });
};
...
const PanelDog = ({ ArrowLoad: ArrowLoad2, BtnLoad: BtnLoad2, connectWalletHandler }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: pigs.map((pig, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(CheckPig, { pig, kyuri, id: index + 1, BtnLoad: BtnLoad2, connectWalletHandler, loadShop }, index)) })
  ] });
};
function App() {
  const gate = "gguf.us";
  ...
  const connectWalletHandler = async () => {
    ...
    try {
      ...
      const contract = new Contract(config[network.chainId.toString()].gguf.address, config.abi, provider2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(HashRouter, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, toggleTheme, installed, isLoading, account, isAdmin, refreshPage, ensName, ensAvatar, accountBalance, connectWalletHandler, BtnLoad, isOwner, nftBalance, chainID, isClosed }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      account && (!isClosed && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/Shop", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopPig, { theme, ArrowLoad, BtnLoad, account, connectWalletHandler, accountBalance, chainID }) })),
      nftBalance > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/Owned", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Owned, { theme, ArrowLoad, account, BtnLoad, connectWalletHandler }) }),
      account == isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/ListPig", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ListPig, { theme, BtnLoad, connectWalletHandler }) }),
      account == isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/PanelEgg", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelEgg, { theme, ArrowLoad, BtnLoad, account, connectWalletHandler, chainID }) }),
      account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/PanelDog", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelDog, { ArrowLoad, BtnLoad, connectWalletHandler }) }),
      account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/PanelPig", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelPig, { theme, ArrowLoad, BtnLoad, account, connectWalletHandler, chainID }) }),
      account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/RoleChanger", element: /* @__PURE__ */ jsxRuntimeExports.jsx(RoleChanger, { theme, BtnLoad, connectWalletHandler, isOwner, isAdmin, isClosed }) }),
      account == isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/WithdrawFund", element: /* @__PURE__ */ jsxRuntimeExports.jsx(WithdrawFund, { theme, BtnLoad, connectWalletHandler, isOwner }) })
    ] })
  ] });
}
